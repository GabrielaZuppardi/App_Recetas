...
export const crearUsuarioSchema = Joi.object({
  ...
  rol: Joi.string().valid('usuario', 'administrador').optional().messages({
    'any.only': "El rol debe ser 'usuario' o 'administrador'"
  }),

  plan: Joi.string().valid('plus', 'premium').optional().messages({
...
export const modificarUsuarioSchema = Joi.object({
  ...
  rol: Joi.string().valid('usuario', 'administrador').messages({
    'any.only': "El rol debe ser 'usuario' o 'administrador'"
  }),
